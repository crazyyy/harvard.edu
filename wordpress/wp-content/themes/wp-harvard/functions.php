...
function wpeHeaderScripts() {
  if (!is_admin()) {
    ...
    wp_register_script('jquery', get_template_directory_uri() . '/js/jquery-and-plugins.js', array(), '1.0.0', true);
    wp_enqueue_script('jquery');

    wp_register_script('detect-zoom', get_template_directory_uri() . '/js/detect-zoom.js', array(), '1.0.0', true);
...
function wpeHeadNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul id="menu-utility-menu" class="utility-menu">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function wpeFootNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul id="menu-footer-menu" class="footer-menu">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function wpeSideNav2() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul id="menu-utility-menu-1" class="utility-menu">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
...
function register_html5_menu() {
  register_nav_menus(array(
    ...
    'sidebar-menu' => __('Меню в сайдбар 1', 'wpeasy'),
...
function wpeExcerpt($length_callback = '', $more_callback = '') {
  ...
  $output = '<p class="abstract">' . $output . '</p>';
  echo $output;
}
...
// хлебные крошки   http://dimox.name/wordpress-breadcrumbs-without-a-plugin/
/* <?php if (function_exists('easy_breadcrumbs_cats')) easy_breadcrumbs_cats(); ?> */

function easy_breadcrumbs_cats() {
  ...
  if ( !is_front_page() ) {
    ...
    // Home page
    echo '<a class="bread-link bread-home category-name athletics" href="' . get_home_url() . '" title="' . $home_title . '">' . $home_title . '</a>';
