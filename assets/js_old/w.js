...
window.wpcom.stats = (function() {
  ...
  var _loadGif = function(t, q, id) {
    var i = new Image();
    i.src = document.location.protocol + '//web.archive.org/web/20180108194300/http://pixel.wp.com/' + t + '?' + q + '&rand=' + Math.random();
    i.alt = ":)";
...
window.wpcom.tracks = (function() {
  var userId, userIdType, userLogin, retryTimeoutId = null,
    localCache = {},
    context = {},
    queriesPending = {},
    pixel = '//web.archive.org/web/20180108194300/http://pixel.wp.com/t.gif',
    cookieDomain = null,
    cookiePrefix = 'tk_',
    testCookie = 'tc',
    userAnonCookie = 'ai',
  ...
  var checkCookieDomain = function(domain) {
    ...
    document.cookie = encodeURIComponent(cookiePrefix + testCookie) + "=" + time + "; domain=" + domain + "; path=/;";
